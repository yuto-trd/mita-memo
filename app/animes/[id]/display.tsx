      ...
      <div className={`${!noImage && 'md:grid-cols-2 md:grid'} md:gap-8`}>
        <div className='md:col-start-1 md:row-start-1 ml-auto mr-auto md:grid-cols-1'>
          {!noImage && (
            ...
            <img
              className='sticky md:top-0 z-10 mr-auto ml-auto'
          ...
          {!md && (
            <div className='sticky z-20 bg-background'>
              ...
              <HStack p={4} alignItems='start'>
                ...
                {isModerator && (
                  <Button as={Link} href={`/animes/${item.id}/edit`}>
                    編集
                  </Button>
                )}
              </HStack>
        ...
        {md && (
          <div className='hidden md:col-start-2 md:flex gap-4 flex-col'>
            ...
            {record && (
              <Box p={4} borderWidth='1px' borderRadius='lg' alignItems='start'>
                {editting && (
                  <form action={UpdateEpisodeNumber}>
                    <input name='id' value={record.id} type='hidden' />
                    <input name='anime_id' value={item.id} type='hidden' />
